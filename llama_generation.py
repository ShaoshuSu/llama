...
class LLAMA_Generation:
    def __init__(self,
        ...
        """
        1.	Answer Format: Responses should be either ‘YES’, ‘NO’, or ‘NOT SURE’.
        2.	Criteria for ‘YES’: You should answer ‘YES’ only when the text explicitly states that the individual is a professor.
        3.	Clarification on Titles: The title ‘Researcher’ or any affiliation to a research institute or university department does not equate to a professorship unless explicitly stated.
        4.	Specificity Required: If the text does not directly confirm the individual’s role as a professor, you should not infer it based on associated titles or roles.
        """
